...
namespace laba5Crossplatform
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Когда вы проведёте Z квадрат загорится зелёным и сможете попробовать ещё раз, есл" +
    "и отклонитесь от курса, то квадрат будет красным и также будет доступна кнопка с" +
    "броса ";
            ...
            this.label3.Location = new System.Drawing.Point(105, 315);
